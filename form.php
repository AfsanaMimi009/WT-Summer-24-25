<!DOCTYPE html>
<html>
<title>This the a registration form </title>
<body>
<center>
<h1 style="color:blue;">AIUB management System </h1>
...
<tr>
    <td>Gender:</td>
    <td><input type="radio" name="des"  value=""> Male </td>

    <td><input type="radio" name="des"  value=""> Other </td>
