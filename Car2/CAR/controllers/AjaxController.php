<?php
// controllers/AjaxController.php - Handle AJAX requests
...
function handleSetAvailability() {
    ...
    if ($is_available) {
        // If setting as available, remove the availability record
        ...
        // If setting as unavailable, add/update availability record
