<?php
// models/Availability.php - Availability model class
...
class Availability {
    ...
    // Set car availability for specific dates
    ...
    // Get car availability for a date range
    ...
    // Get blocked dates (including bookings)
